...
urlpatterns = [
    ...
    url(r'^jochen/$', TemplateView.as_view(template_name='pages/jochen.html'), name='jochen'),
    url(r'^katharina/$', TemplateView.as_view(template_name='pages/katharina.html'), name='katharina'),
